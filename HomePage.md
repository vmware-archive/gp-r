...
A desktop demo of the debut release of PivotalR is provided [here](https://github.com/wjjung317/gp-r/blob/master/videos/PivotalRDemo-20130605.arf).  The powerpoint presentation used in the video is provided [here](https://github.com/wjjung317/gp-r/blob/master/docs/PivotalR_Demo.pptx). Note that the demo is intends to highlight a selection of functionality in PivotalR - we encourage you to check out the documentation and explore all of its features.  
